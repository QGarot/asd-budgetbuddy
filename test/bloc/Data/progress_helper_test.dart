...
void main() {
  group('computeProgressSummary', () {
    test('correctly computes monthly progress with one budget and one expense', () {
      final budget = Budget(
        name: 'Groceries',
        category: 'Food',
    ...
    test('correctly computes weekly progress with one budget and one expense', () {
      final budget = Budget(
        name: 'Transport',
        category: 'Travel',
        createdAt: DateTime(2025, 4, 1),
    ...
    test('correctly computes biweekly progress with one budget and one expense', () {
      final budget = Budget(
        name: 'Dining',
        category: 'Food',
