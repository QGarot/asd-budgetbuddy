...
void main() {
  testWidgets('HomeScreen renders dashboard title and subtitle', (WidgetTester tester) async {
    final mockAuthCubit = MockAuthCubit();
    final mockDataCubit = MockDataCubit();

    // Provide minimal dummy user data
    when(mockAuthCubit.state).thenReturn(AuthUserData(
      uid: 'test-uid',
    ...
    // Texts expected from HomeScreen layout
    expect(find.text('Budget Dashboard'), findsNWidgets(2)); // Title + Sidebar
