...
void main() {
  group('BudgetProgressBar Widget Tests', () {
    testWidgets('displays correct budget usage percentage', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(body: BudgetProgressBar(summary: summary)),
        ),
      );
    ...
    testWidgets('progress bar shows correct width based on budget usage', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        find.byWidgetPredicate(
          (widget) =>
              ...
              (widget.constraints as BoxConstraints).maxWidth ==
                  double.infinity,
        ),
        findsWidgets,
      );
    ...
    testWidgets('progress bar changes color when over 80% of budget is used', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        gradient.colors.any(
          (color) => color == Colors.red[400] || color == Colors.orange[400],
        ),
        isTrue,
      );
    });

    testWidgets('progress bar handles case when budget is exceeded', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('handles zero budget case gracefully', (
      WidgetTester tester,
    ) async {
